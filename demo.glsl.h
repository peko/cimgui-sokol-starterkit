...
/*
    ...
    Cmdline:
        sokol-shdc --input demo.glsl --output demo.glsl.h --slang glsl430 --genver 5 --errfmt gcc --format sokol --bytecode

    Overview:
    =========
    Shader program: 'demo':
        Get shader desc: demo_shader_desc(sg_query_backend());
        Vertex shader: vs
            Attributes:
                ATTR_vs_position => 0
                ATTR_vs_color0 => 1
...
static inline const sg_shader_desc* demo_shader_desc(sg_backend backend) {
